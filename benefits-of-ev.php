...
<section>
        ...
        <div class="container mt-do">
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <h2 class="about-us-title">Benefits of Electric Vehicles</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mb-40 welcome-bg">
        <div class="container">
            ...
            <div class="row pt-50">
                <div class="col-md-8 col-sm-12 sm-flex-order2">
                    <p class="myths-hear-title mb-0">Low maintenance cost</p>
                ...
                <div class="col-md-4 col-sm-12 sm-flex-order1">
                    <img class="img-fluid" src="img/low-maintenance.jpg">
                </div>
            </div>
            <div class="row pt-50">
                <div class="col-md-4 col-sm-12">
                    <img class="img-fluid" src="img/no-carobn.jpg">
                </div>
                <div class="col-md-8 col-sm-12">
                    <p class="myths-hear-title mb-0"> Zero Tailpipe Emissions</p>
            ...
            <div class="row pt-50">
                <div class="col-md-8 col-sm-12 sm-flex-order2">
                    <p class="myths-hear-title mb-0">Tax and financial benefits
                    </p>


                    <p class="ev-awareness-para">
                        Registration fees and road tax on purchasing electric vehicles are lesser than petrol or diesel vehicles. There are multiple policies and incentives offered by the government depending on which state you are in. To find out more about electric vehicle incentives, click below .</p>
                        <p class="ev-awareness-para">
                            <a href="ev-incentives.php" class="d-flex align-items-center text-uppercase">Electric vehicle incentive   <i class="fa fa-arrow-right pl-2" aria-hidden="true"></i></a></p>

                </div>
                <div class="col-md-4 col-sm-12 sm-flex-order1">
                    <img class="img-fluid" src="img/ta-saving.jpg">
                </div>
            </div>
            <div class="row pt-50">
                <div class="col-md-4 col-sm-12">
                    <img class="img-fluid" src="img/Petrol-and-diesel.jpg">
                </div>
                <div class="col-md-8 col-sm-12">
                    <p class="myths-hear-title mb-0"> Petrol and diesel use is destroying our planet</p>
            ...
            <div class="row pt-50">
                <div class="col-md-8 col-sm-12 sm-flex-order2">
                    <p class="myths-hear-title mb-0"> Electric Vehicles are easy to drive and quiet </p>
                ...
                <div class="col-md-4 col-sm-12 sm-flex-order1">
                    <img class="img-fluid" src="img/easy-drive.jpg">
                </div>
            </div>

            <div class="row pt-50">
                <div class="col-md-4 col-sm-12">
                    <img class="img-fluid" src="img/home-charging.jpg">
                </div>
                <div class="col-md-8 col-sm-12">
                    <p class="myths-hear-title mb-0">Convenience of charging at home
                    </p>
            ...
            <div class="row pt-50">
                <div class="col-md-8 col-sm-12 sm-flex-order2">
                    <p class="myths-hear-title mb-0">No noise pollution
                    </p>
                ...
                <div class="col-md-4 col-sm-12 sm-flex-order1">
                    <img class="img-fluid" src="img/no-noise.jpg">
                </div>
            </div>
