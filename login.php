        ...
        <div class="container mt-do">
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <h2 class="about-us-title">Login to start using this tool</h2>
                </div>
            </div>
        </div>
    </div>
...
<main class="container"><br />      
      <h3><i class="fa fa-lock"></i>&nbsp; Login! Already registered User</h3>
      <div class="reg-container"><br />
        ...
        <form action="" method="post" id="login-form">
          ...
          <span class="material-symbols-outlined icon-style">email</span> <input type="email" name="email" class="input-reg" placeholder="E-mail" /> <br /><br />
          <span class="material-symbols-outlined icon-style">lock</span> <input type="password" name="password" class="input-reg" placeholder="Password" /> <br /><br />

          <div class="grid-reg-down">
            <div style="text-align: left;"><p> If you have not registered, <a href="register.php" style="text-decoration: none; color:rgb(248, 122, 122);">click here</a> to register. otherwise login</p> </div>
            <div>
              <button type="submit" class="butt" id="login-btn">Login &#8594; </button>
            </div>
          </div>   
        </form>             
