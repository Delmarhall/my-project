        ...
        <div class="d-flex flex-wrap w-100">
            ...
            <div class="footer-col">
                <div class="d-flex flex-column footer_box">
                    ...
                    <a href="javascript:void(0);" onclick="calculator1()" class="footer_links">Home Charger</a>
                    <a href="javascript:void(0);" onclick="calculator2()" class="footer_links">Public Charger</a>
                </div>
            </div>
            <div class="footer-col border-rgt">
                <div class="d-flex flex-column footer_box">
                    <a href="#" class="footer_links">Account</a>
                    <a href="dashboard.php" class="footer_links">My Dashboard</a>
                    <a href="configurations/logout.php" class="footer_links">Log Out</a>
                    <p></p>
                    <a href="dashboard.php"><p class="mb-0 footer_contact" style="text-align:center;"> &nbsp; &nbsp; <img src="../../img/logo1.png" width="100vw"></p></a>
                </div>
            </div>
