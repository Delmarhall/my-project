      ...
      <div class="container mt-do">
          <div class="row">
              <div class="col-md-12 col-lg-12">
                  <h2 class="about-us-title">EV Charging at Home</h2>
              </div>
          </div>
      </div>
  </div>
...
<div class="grid-container">
  <div class="grid-item order2" id="hide" >
    <h3 class="header" style="font-family: magneto; color:white; background:#185589; text-align:center;">Home Charging Calculator</h3><br>
        <div>
          ...
          <input type="number" name="power" id="power" placeholder="Home charging power" min="1" max="8" required/><br>

          <label for="voltage">Residential line voltage</label>
          <input type="number" name="voltage" id="voltage" placeholder="Specify your country residential line voltage (volts)" required/><br>

          <label for="cost">Electricity Tariff</label>
          <input type="number" name="cost" id="cost" placeholder="Residential Electricity tariff per unit kWh" required/><br>
    ...
    <div class="grid-item order1" id="show" style="display:none;">
      ...
      <table class="receipt-text">
        ...
        <tr>
          <td>Residential Line Voltage</td>
          <td><span id="receipt-voltage"></span></td>
        </tr>
        <tr>
          <td>Current Required for Charging:</td>
...
function myCalculator() {
  ...
  //Calculating the amount of current needed by the home charger
  let currentNeeded = (chargingPower * 1000) / voltage;
  document.getElementById("receipt-voltage").innerHTML = voltage + " volts";
  document.getElementById("current").innerHTML = currentNeeded.toFixed(2) + " Amps";
  }

  // Function to redirect to the Public page
